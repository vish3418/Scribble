...
<html lang="en">
  ...
  <body id="contact">
    <nav role="navigation" class="navbar navbar-custom navbar-fixed-top">
      ...
      <!--Contact-->
      <div class="hey" id="callUs">
          <p><font color="white">If you would like to contact us please reach us through the following:</font></p>
          <br>
          <br>
          <br>
          <p><font color="white">Email: Scribble@gmail.com</font></p>
          <br>
          <br>
          <br>
          <p><font color="white">Instagram: @Scribble</font></p>
          <br>
          <br>
          <br>
          <p><font color="white">Snapchat: Scribble</font></p>
      </div>
